...
public function __construct($nome_p, $sobrenome_p, $documento_p, $nbagagens_p, $vip_p, $nacionalidade_p, $cpf_p, $data_de_nascimento_p, $data_atual_p, $email_p, $assento_p,$programa_de_milhagem=null,$registro=null ){
    try{
    ...
    $this->set_programa_de_milhagem($programa_de_milhagem);
